        ...
        <table class="min-w-full bg-white">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium tracking-wider text-gray-500 uppercase">
                        Número
                    </th>
                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium tracking-wider text-gray-500 uppercase">
                        E-mail
            ...
            <tbody class="divide-y divide-gray-200">
                <tr v-for="cliente in clientes" :key="cliente.id" class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-right text-sm font-medium whitespace-nowrap flex justify-end gap-3">
