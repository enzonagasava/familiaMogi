...
watch(() => props.periodoValor, (newVal) => periodoValor.value = newVal)
watch(() => props.periodoEntregas, (newVal) => periodoEntregas.value = newVal)
watch(() => props.periodoProdutos, (newVal) => periodoProdutos.value = newVal)
watch(() => props.periodoClientes, (newVal) => periodoClientes.value = newVal)
...
<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="space-y-2">
        <PeriodSelector 
          v-model="periodoValor" 
          @update:model-value="handlePeriodoValor"
        />
        <div class="h-80">
      ...
      <div class="space-y-2">
        <PeriodSelector 
          v-model="periodoEntregas" 
          @update:model-value="handlePeriodoEntregas"
        />
        <div class="h-80">
          <ChartEntregas :data="dashboardData.entregasPorDia" :periodo="periodoEntregas" />
        </div>
      </div>      <!-- Gráfico de Produtos Vendidos -->
      <div class="space-y-2">
        <PeriodSelector 
          v-model="periodoProdutos" 
          @update:model-value="handlePeriodoProdutos"
        />
        <div class="h-80">
      ...
      <div class="space-y-2">
        <PeriodSelector 
          v-model="periodoClientes" 
          @update:model-value="handlePeriodoClientes"
        />
        <div class="h-80">
