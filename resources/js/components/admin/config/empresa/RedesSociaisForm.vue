...
<template>
  <form @submit.prevent="submit" class="grid gap-4 md:grid-cols-3">
    <div>
      <Label class="block font-semibold mb-2 text-gray-700" for="facebook">Facebook</Label>
      <Input id="facebook" v-model="form.facebook" placeholder="https://facebook.com/..." />
    </div>

    <div>
      <Label class="block font-semibold mb-2 text-gray-700" for="instagram">Instagram</Label>
      <Input id="instagram" v-model="form.instagram" placeholder="https://instagram.com/..." />
    </div>

    <div>
      <Label class="block font-semibold mb-2 text-gray-700" for="linkedin">LinkedIn</Label>
      <Input id="linkedin" v-model="form.linkedin" placeholder="https://linkedin.com/..." />
    </div>

    <div>
      <Label class="block font-semibold mb-2 text-gray-700" for="youtube">YouTube</Label>
      <Input id="youtube" v-model="form.youtube" placeholder="https://youtube.com/..." />
    </div>

    <div>
      <Label class="block font-semibold mb-2 text-gray-700" for="tiktok">TikTok</Label>
      <Input id="tiktok" v-model="form.tiktok" placeholder="https://tiktok.com/..." />
    </div>

    <div>
      <Label class="block font-semibold mb-2 text-gray-700" for="x">X (Twitter)</Label>
