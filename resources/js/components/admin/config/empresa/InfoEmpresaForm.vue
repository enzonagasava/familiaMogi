...
<template>
  <form @submit.prevent="submit" >
    <div  class="grid gap-6 md:grid-cols-3 mb-6">
       <div>
          <Label class="block font-semibold mb-2 text-gray-700" for="nome">Nome da Empresa</Label>
          <Input id="nome" v-model="form.nome" required placeholder="Nome da Empresa" />
          <InputError class="mt-2" :message="form.errors.nome" />
        </div>

        <div>
          <Label class="block font-semibold mb-2 text-gray-700" for="email">Email Empresarial</Label>
          <Input id="email" type="email" v-model="form.email" required placeholder="Email empresarial" />
          <InputError class="mt-2" :message="form.errors.email" />
        </div>

        <div>
          <Label class="block font-semibold mb-2 text-gray-700" for="numero_wpp">Número WhatsApp</Label>
          <Input
            id="numero_wpp"
            type="text"
            v-maska="'(##) #####-####'"
            v-model="form.numero_wpp"
            required
        ...
        <div>
          <Label class="block font-semibold mb-2 text-gray-700" for="telefone">Telefone Fixo</Label>
          <Input
            id="telefone"
            type="text"
            v-maska="'(##) ####-####'"
        ...
        <div>
          <Label class="block font-semibold mb-2 text-gray-700" for="cnpj">CNPJ</Label>
        ...
        <div>
          <h3 class="block font-semibold mb-2 text-gray-700">Endereço:</h3>
          <div class="grid gap-6 md:grid-cols-3 mb-5">
            <div>
              <Label class="block font-semibold mb-2 text-gray-700" for="cep">CEP</Label>
              <Input id="cep" type="text" v-maska="'#####-###'" v-model="form.cep" placeholder="00000-000" />
              <InputError class="mt-2" :message="form.errors.cep" />
            </div>

            <div class="md:col-span-2">
              <Label class="block font-semibold mb-2 text-gray-700" for="endereco">Endereço</Label>
          ...
          <div class="grid gap-6 md:grid-cols-3">
            <div>
              <Label class="block font-semibold mb-2 text-gray-700" for="numero_endereco">Número</Label>
            ...
            <div>
              <Label class="block font-semibold mb-2 text-gray-700" for="municipio">Município</Label>
            ...
            <div>
              <Label class="block font-semibold mb-2 text-gray-700" for="estado">UF</Label>
